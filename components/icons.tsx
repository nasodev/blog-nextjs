...
export const SunIcon3 = ({ className = "", ...rest }: SvgComponentProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const SunIcon = ({ className = "", ...rest }: SvgComponentProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
    ...
    >
        ...
        >
            <path d="M0 0">
                ...
                ></animate>
                <animate fill="freeze" attributeName="stroke-dashoffset" begin="1.2s" dur="0.2s" values="2;0"></animate>
            </path>
            <path d="M0 0">
                <animate
                    fill="freeze"
                ...
                ></animate>
                <animate fill="freeze" attributeName="stroke-dashoffset" begin="1.5s" dur="1.2s" values="2;0"></animate>
            </path>
            <animateTransform
        ...
        <g fill="currentColor">
            <path d="M15.22 6.03L17.75 4.09L14.56 4L13.5 1L12.44 4L9.25 4.09L11.78 6.03L10.87 9.09L13.5 7.28L16.13 9.09L15.22 6.03Z">
                <animate fill="freeze" attributeName="fill-opacity" dur="0.4s" values="1;0"></animate>
            </path>
        ...
        <mask id="lineMdMoonFilledToSunnyFilledLoopTransition0">
            ...
            <circle cx="18" cy="6" r="12" fill="#fff">
                <animate fill="freeze" attributeName="cx" begin="0.6s" dur="0.4s" values="18;22"></animate>
                <animate fill="freeze" attributeName="cy" begin="0.6s" dur="0.4s" values="6;2"></animate>
                <animate fill="freeze" attributeName="r" begin="0.6s" dur="0.4s" values="12;3"></animate>
            </circle>
        ...
        <circle
            ...
            opacity="0"
        >
            <animate attributeName="opacity" begin="0.6s" dur="0.01s" values="0;1" fill="freeze" />
            <animate fill="freeze" attributeName="r" begin="0.6s" dur="0.4s" values="10;6" />
        </circle>
    </svg>
);

export const MoonIcon = ({ className = "", ...rest }: SvgComponentProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const TwitterIcon = ({ className = "", ...rest }: SvgComponentProps) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={42}
...
export const GithubIcon = ({ className = "", ...rest }: SvgComponentProps) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={42}
...
export const DribbbleIcon = ({ className = "", ...rest }: SvgComponentProps) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={42}
